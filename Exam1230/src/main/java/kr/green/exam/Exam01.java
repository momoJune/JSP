...
public class Exam01 {
	...
	@Test
	public void test() {
		assertArrayEquals(new Exam01().solution(5, new int[] {2, 1, 2, 6, 2, 4, 3, 3}), new int[] {3,4,2,1,5});
		assertArrayEquals(new Exam01().solution(4, new int[] {4,4,4,4,4}), new int[] {4,1,2,3});
	}
}
