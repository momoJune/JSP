...
<style type="text/css">   /*  10~15 라인   CSS : 스타일을 꾸밀 때 사용하는 스타일 시트 언어. 이 문서를 꾸며주는 역할 */
	table {	width: 700px;margin: auto; border: none;} 	/* 넓이: 700px , 중앙 , 테두리 none */
	.title {font-size: 24pt; text-align: center; border: none;background-color: white;} 	/* 제목: 폰트사이즈, 텍스트위치, 테두리, 뒷배경 설정 */
	th { border: 1px solid gray; width: 100px;padding: 20px; background-color: silver; border-radius: 20px; } 	/* 60번 줄부터 있는 th 값들 꾸며주기 */
	td { border: 1px solid gray; width: 100px;padding: 10px; height: 80px; line-height: 30px;  		/* td 값들 꾸며주기 */
...
<body>
	<%
		LocalDate today = LocalDate.now();	//LocalDate와 LocalTime 클래스는 객체를 생성하기 위해서 now()와 of() 메소드라는 클래스 메소드를 제공합니다.
