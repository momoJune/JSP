...
<%
	...
	request.setAttribute("pv", pagingVO); // 리퀘스트 영역에 저장한다.
	request.setAttribute("p", currentPage); // 리퀘스트 영역에 저장한다.
	request.setAttribute("s", sizeOfPage); // 리퀘스트 영역에 저장한다.
	request.setAttribute("b", sizeOfBlock); // 리퀘스트 영역에 저장한다.
