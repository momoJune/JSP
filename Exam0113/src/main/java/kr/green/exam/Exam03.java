...
public class Exam03 {
	...
	@Test
	public void test() {
		assertArrayEquals(new Exam03().solution(2,5), new long[] {2,4,6,8,10});
		assertArrayEquals(new Exam03().solution(4,3), new long[] {4,8,12});
		assertArrayEquals(new Exam03().solution(-4,2), new long[] {-4, -8});
